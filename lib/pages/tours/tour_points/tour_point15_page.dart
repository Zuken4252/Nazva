...
class _TourPoint15PageState extends State<TourPoint15Page> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Карл Бер - Точка 15"),
      ),
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              ...
              "был одним из крупнейших естествоиспытателей девятнадцатого века. Родившись и получив образование в Эстонии, он вёл научную "
              "деятельность в разных странах Европы, оставив значительный след сразу в нескольких областях науки. \n\n"

              "Он известен как основатель эмбриологии: именно Бэр открыл яйцеклетку млекопитающих и подробно описал развитие эмбриона. "
              "Кроме того, он стоял у истоков экологии, исследовал рыбные ресурсы Балтийского моря и заложил основы научного рыболовства. \n\n"

              "Помимо этого, учёный сделал важные открытия в географии и антропологии, а также активно занимался организацией научной "
              "деятельности, став основателем нескольких научных обществ. \n\n"
